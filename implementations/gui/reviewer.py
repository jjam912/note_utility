...
class ReviewerView:
    ...
    def init_top_frame(self):
        ...
        self.generate_button = tk.Button(top_frame, text="Generate", takefocus=False,
    ...
    def init_question_text(self):
        ...
        self.question_text = tk.Text(question_frame, wrap=tk.WORD, width=1, height=1, takefocus=False,
    ...
    def init_answer_text(self):
        ...
        self.answer_text = tk.Text(answer_frame, wrap=tk.WORD, width=1, height=1, takefocus=False,
                                   font=tkfont.Font(family="Ubuntu", size=12))
    ...
    def init_button_frame(self):
        ...
        self.correct_button.bind("<Return>", lambda e: self.controller.on_add_correct())
        self.incorrect_button.bind("<Return>", lambda e: self.controller.on_add_incorrect())
        self.reveal_button.bind("<Return>", lambda e: self.controller.on_reveal())
