...
class Note(abc.ABC):
    ...
    def __init__(self, content, nindex, rcontent, prefix, extensions, categories, tabs, fmt):
        ...
        prefix : str
            Any prefixes this Note had that were used to determine type of Note or Category.
        extensions: dict of {str : :class:`Extension`}
            A dict of the Extensions that this Note has with key: :attr:`Extension.name` and value: :class:`Extension`.
        categories: list of :class:`Category`
